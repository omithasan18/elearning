                    ...
                    <div class="col-md-12">
                        <form action="{{route('admin.lesson.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body" id="showLessonArea" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="text-right">Lesson Name<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="name" placeholder="Lesson Name" id="valid_lesson_name_slug">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="youtube_link" placeholder="Lesson youtube link">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="lesson_time" placeholder="Lesson Time">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control summernote" name="description" placeholder="Lesson Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer" id="showLessonAreaFooter" style="display: none;">
                                    <div class="row">
