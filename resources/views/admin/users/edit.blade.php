                                ...
                                <form action="{{route('admin.users.update', $users->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="User Name" value="{{$users->name}}" id="valid_User_name_slug">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="role_id" class="form-control">
                                                    ...
                                                    @foreach($roles as $role)
                                                        <option @if($role->id == $users->role_id) selected @endif value="{{ $role->id }}">{{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" class="form-control" value="{{$users->email}}" name="email" placeholder="Email Address">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="">Phone Number</label>
                                            <input type="number" class="form-control" value="{{$users->phone}}" name="phone" placeholder="Phone Number">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <img width="80" height="80" src="{{ asset($users->image) }}" id="loadImage">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" class="form-control" cols="30" rows="4" placeholder="User Address">{{ $users->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
