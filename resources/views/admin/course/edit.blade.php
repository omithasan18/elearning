                ...
                <div class="row mb-1">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard', $course->id) }}">Home</a></li>
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.course.update', $course->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" value="{{ $course->name }}" placeholder="Course Name" id="valid_course_name_slug">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <img width="80" height="80" src="{{ asset($course->image) }}" id="loadImage">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_description" onkeyup="countChars(this);" class="form-control" id="" cols="30" rows="5" placeholder="Short Description">{{ $course->short_description }}</textarea>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="course_for" class="form-control">
                                                    <option @if($course->course_for == "Beginner") selected @endif value="Beginner" selected>Beginner</option>
                                                    <option @if($course->course_for == "Intermediate") selected @endif value="Intermediate">Intermediate</option>
                                                    <option @if($course->course_for == "Advanced") selected @endif value="Advanced">Advanced</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="lession_count" class="form-control" value="{{ $course->lession_count }}" placeholder="Lession Count">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="text-right">Course Time  <span class="text-danger">*</span></label>
                                                <input type="text" name="course_time" class="form-control" value="{{ $course->course_time }}" placeholder="Course Time Hours / Minuites">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
