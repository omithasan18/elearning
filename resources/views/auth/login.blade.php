                ...
                <div class="max-w-[500px] mx-auto order-first md:order-last relative md:static md:order-first p-10 md:p-0 bg-white md:bg-transparent rounded-lg md:rounded-0">
                    <div class="max-w-[300px] mx-auto text-gray-700">
                        ...
                        <form class="space-y-3" action="{{ route('login') }}" method="post">
                            @csrf
                            <div class="nice-form">
                                <input type="email" name="email" value="{{old('')}}" class="nice-form__input" placeholder="Email" required autofocus>
                                <span class="nice-form__prepend">Email</span>
                            </div>
                            <div class="nice-form">
                                <input type="password" name="password" class="nice-form__input" placeholder="Passowrd" required autocomplete="current-password">
